---
name: mirach-omarchy
description: Omarchy system management commands (omarchy-*), theme control, service restarts, Hyprland config rules. Use when the user asks about themes, restarting services, screenshots, nightlight, or any Omarchy/Hyprland task.
---
