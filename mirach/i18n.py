...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "action_denied": "Okay, I won't do that.",
        "action_blocked": "I'm not allowed to do that.",
    ...
    "es": {
        ...
        "action_denied": "De acuerdo, no lo haré.",
        "action_blocked": "No tengo permitido hacer eso.",
