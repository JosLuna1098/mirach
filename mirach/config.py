...
CODING_KEYWORDS = [
    "script", "code", "programa", "funcion", "function", "clase", "class",
    "modulo", "module", "api", "bug", "debug", "compilar", "compile",
    "build", "test", "implementar", "implement", "algoritmo", "algorithm",
    "python", "javascript", "rust", "bash", "shell", "crear un", "crea un",
    "escribir un", "write a", "generar", "generate",
]
